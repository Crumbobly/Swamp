    ...
    return (
        ...
        <main>
            <div className="row mx-4 mx-md-4 py-3 d-flex overflow-hidden flex-column h-100">
                ...
                <div className="col col-12 col-xl-10 col-lg-9 p-0 ps-lg-3 d-flex overflow-hidden flex-column h-100">

                    <nav className="navbar navbar-light bg-light background_rounded mb-3">
